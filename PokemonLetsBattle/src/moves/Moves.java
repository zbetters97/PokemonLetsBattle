...
public enum Moves {
	...
	DREAMEATER ("Dream Eater", MoveType.SPECIAL, Type.PSYCHIC, 15, 100, 100, 
			"An attack that works only on\na sleeping foe. It absorbs\nhalf the damage caused to\nheal the user's HP."),
	...
	ENDEAVOR ("Endeavor", MoveType.PHYSICAL, Type.NORMAL, 5, 1, 100, 
			"An attack move that cuts down\nthe foe's HP to equal the\nuser's HP."),
	...
	PETALDANCE ("Petal Dance", MoveType.SPECIAL, Type.GRASS, 20, 90, 100, 2, false, false, 
			"",
			"The user attacks by scat-\ntering petals for two to\nthree turns. The user then\nbecomes confused."),
