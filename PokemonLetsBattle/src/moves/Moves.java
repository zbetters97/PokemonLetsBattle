...
public enum Moves {
	...
	AGILITY ("Agility", MoveType.ATTRIBUTE, Type.PSYCHIC, true, 30, -1, 1, Arrays.asList("speed"), 
			"The user relaxes and lightens its body to move faster. It sharply boosts the Sspeed stat."),
	...
	AURORABEAM ("Aurora Beam", MoveType.SPECIAL, Type.ICE, 20, 65, 100, 
			"The foe is hit with a rainbow-colored beam."),
	...
	DIG ("Dig", MoveType.PHYSICAL, Type.GROUND, 10, 80, 100, false, 
			"dug into the ground!", "The user burrows, then attacks on the second turn. It can also be used to exit dungeons."),
	...
	FLY ("Fly", MoveType.PHYSICAL, Type.FLYING, 15, 90, 95, false, "took flight!", 
	...
	ICEFANG ("Ice Fang", MoveType.PHYSICAL, Type.ICE, Status.FREEZE, 0.10, 15, 65, 95, 
			"The user bites with cold-infused fangs. It may also make the foe freeze."),
	...
	SOLARBEAM ("Solar Beam", MoveType.SPECIAL, Type.GRASS, 10, 180, 100, true, 
	...
	THUNDERFANG ("Thunder Fang", MoveType.PHYSICAL, Type.ELECTRIC, Status.PARALYZE, 0.10, 15, 65, 95, 
			"The user bites with electrified fangs. It may also make the foe paralyzed."),
	...
	private int pp, power, accuracy, level, crit;
	...
	Moves (String name, MoveType mType, Type type, 
			...
			int pp, int power, int accuracy, int level, int crit,
	...
	Moves (String name, MoveType mType, Type type, int pp, int power, int accuracy, boolean isProtected, String delay, String info) {
		this(name, mType, type, 
				null, 0.0, 
				null, false, 
				pp, power, accuracy, 0, 0, 
