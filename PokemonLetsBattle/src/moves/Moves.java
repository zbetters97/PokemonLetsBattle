...
public enum Moves {
	...
	BRICKBREAK ("Brick Break", MoveType.PHYSICAL, Type.FIGHTING, 15, 75, 100, 
	...
	BULLETPUNCH ("Bullet Punch", MoveType.PHYSICAL, Type.STEEL, 30, 40, 100, true, 
	...
	CLOSECOMBAT ("Close Combat", MoveType.PHYSICAL, Type.FIGHTING, false, 1.0, 5, 120, 100, 1, Arrays.asList("sp. attack", "sp. defense"),
	...
	DRAGONRUSH ("Dragon Rush", MoveType.PHYSICAL, Type.DRAGON, 10, 100, 75, 1,
	...
	HIGHJUMPKICK ("High Jump Kick", MoveType.PHYSICAL, Type.FIGHTING, 20, 100, 90, 
	...
	ICEPUNCH ("Ice Punch", MoveType.PHYSICAL, Type.ICE, Status.FREEZE, 0.10, 15, 75, 100, 
	...
	JUMPKICK ("Jump Kick", MoveType.PHYSICAL, Type.FIGHTING, 25, 85, 95, 
	...
	MACHPUNCH ("Mach Punch", MoveType.PHYSICAL, Type.FIGHTING, 30, 40, 100, true,
	...
	MEDITATE ("Meditate", MoveType.ATTRIBUTE, Type.PSYCHIC, true, 40, -1, 1, Arrays.asList("attack"), 
	...
	MEGAKICK ("Mega Kick", MoveType.PHYSICAL, Type.NORMAL, 5, 120, 75, 
	...
	PLUCK ("Pluck", MoveType.PHYSICAL, Type.FLYING, 20, 60, 100, 
	...
	ROLLINGKICK ("Rolling Kick", MoveType.PHYSICAL, Type.FIGHTING, 15, 60, 85, 1, 
	...
	ROOST ("Roost", MoveType.OTHER, Type.FLYING, 10, -1, -1,
	...
	VACUUMWAVE ("Vacuum Wave", MoveType.SPECIAL, Type.FIGHTING, 30, 40, 100, true, 
