...
public enum Moves {
	...
	AGILITY ("Agility", MoveType.ATTRIBUTE, Type.PSYCHIC, true, 30, -1, -1, 0, 1,  Arrays.asList("speed"), 
	...
	AMNESIA ("Amnesia", MoveType.ATTRIBUTE, Type.PSYCHIC, true, 20, -1, -1, 0, 2, Arrays.asList("sp. defense"),
	...
	BARRIER ("Barrier", MoveType.ATTRIBUTE, Type.PSYCHIC, true, 30, -1, -1, 0, 2, Arrays.asList("defense"), 
	...
	BUBBLEBEAM ("Bubblebeam", MoveType.SPECIAL, Type.WATER, false, 0.10, 20, 65, 100, 0, -1, Arrays.asList("speed"),
	...
	CLOSECOMBAT ("Close Combat", MoveType.PHYSICAL, Type.FIGHTING, false, 1.0, 5, 120, 100, 0, 1, Arrays.asList("sp. attack", "sp. defense"),
	...
	DEFENSECURL ("Defense Curl", MoveType.ATTRIBUTE, Type.NORMAL, true, 40, -1, -1, 0, 1, Arrays.asList("defense"), 
	...
	DOUBLETEAM ("Double Team", MoveType.ATTRIBUTE, Type.NORMAL, true, 15, -1, -1, 0, 1, Arrays.asList("evasion"), 
	...
	EARTHPOWER ("Earth Power", MoveType.SPECIAL, Type.GROUND, false, 0.10, 10, 90, 100, 0, -1, Arrays.asList("sp. defense"),
	...
	FEINT ("Feint", MoveType.PHYSICAL, Type.NORMAL, 10, 50, 100, 0, 
			"An attack that hits a foe\nusing Protect or Detect. It\nalso lifts the effects of\nthose moves."),
	...
	FOCUSBLAST ("Focus Blast", MoveType.SPECIAL, Type.FIGHTING, false, 0.10, 5, 120, 70, 0, -1, Arrays.asList("sp. defense"), 
	...
	GROWL ("Growl", MoveType.ATTRIBUTE, Type.NORMAL, false, 40, -1, 100, 0, -1, Arrays.asList("attack"), 
	...
	HAMMERARM ("Hammer Arm", MoveType.PHYSICAL, Type.FIGHTING, true, 1.0, 10, 100, 90, 0, -1, Arrays.asList("speed"),
	...
	HOWL ("Howl", MoveType.ATTRIBUTE, Type.NORMAL, true, 40, -1, -1, 0, 1, Arrays.asList("attack"),
	...
	IRONTAIL ("Iron Tail", MoveType.PHYSICAL, Type.STEEL, false, 0.30, 15, 100, 75, 0, -1, Arrays.asList("defense"),
	...
	KINESIS ("Kinesis", MoveType.ATTRIBUTE, Type.PSYCHIC, false, 15, -1, 80, 0, -1, Arrays.asList("accuracy"), 
	...
	LEER ("Leer", MoveType.ATTRIBUTE, Type.NORMAL, false, 30, -1, 100, 0, -1, Arrays.asList("defense"), 
	...
	MEDITATE ("Meditate", MoveType.ATTRIBUTE, Type.PSYCHIC, true, 40, -1, -1, 0, 1, Arrays.asList("attack"), 
			"The user meditates to awaken\nthe power deep within its\nbody and raise its Attack\nstat."),
	...
	MUDBOMB ("Mud Bomb", MoveType.SPECIAL, Type.GROUND, false, 0.30, 10, 65, 85, 0, -1, Arrays.asList("accuracy"), 
			"The user launches a hard-\npacked mud ball to attack.\nIt may also lower the\ntarget's Accuracy."),
	MUDSHOT ("Mud Shot", MoveType.SPECIAL, Type.GROUND, false, 1.0, 15, 55, 95, 0, -1, Arrays.asList("speed"), 
			"The user attacks by hurling\na blob of mud at the foe.\nIt also reduces the\ntarget's Speed."),
	MUDSLAP ("Mud Slap", MoveType.SPECIAL, Type.GROUND, false, 1.0, 10, 20, 100, 0, -1, Arrays.asList("accuracy"),
			"The user hurls mud in the\nfoe's face to inflict damage\nand lower its Accuracy."),
	MUDDYWATER ("Muddy Water", MoveType.SPECIAL, Type.WATER, false, 0.30, 10, 95, 85, 0, -1, Arrays.asList("accuracy"), 
			"The user attacks by\nshooting out muddy water.\nIt may also lower the foe's\nAccuracy."),
	NASTYPLOT ("Nasty Plot", MoveType.ATTRIBUTE, Type.DARK, true, 20, -1, -1, 0, 2, Arrays.asList("sp. attack"),
	...
	PLAYNICE ("Play Nice", MoveType.ATTRIBUTE, Type.NORMAL, false, 20, -1, -1, 0, -1, Arrays.asList("attack"), 
	...
	ROOST ("Roost", MoveType.OTHER, Type.FLYING, 10, -1, -1, 0,
			"The user lands and rests its\nbody. It restores the user's\nHP by up to half of its max\nHP."),
	SANDATTACK ("Sand Attack", MoveType.ATTRIBUTE, Type.GROUND, false, 15, 100, -1, 0, -1, Arrays.asList("accuracy"),
	...
	SCARYFACE ("Scary Face", MoveType.ATTRIBUTE, Type.NORMAL, false, 10, -1, 90, 0, -2, Arrays.asList("speed"), 
	...
	SCREECH ("Screech", MoveType.ATTRIBUTE, Type.NORMAL, false, 40, -1, 85, 0, -2, Arrays.asList("defense"),
	...
	SMOKESCREEN ("Smokescreen", MoveType.ATTRIBUTE, Type.NORMAL, false, 20, -1, 100, 0, -1, Arrays.asList("accuracy"),
	...
	SWAGGER ("Swagger", MoveType.ATTRIBUTE, Type.NORMAL, false, 15, -1, 90, 0, 2, Arrays.asList("attack"),
			"The user enrages the foe\ninto confusion. However, it\nalso sharply raises the\nfoe's Attack stat."),
	SWEETSCENT ("Sweet Scent", MoveType.ATTRIBUTE, Type.NORMAL, false, 20, -1, 100, 0, -1, Arrays.asList("evasion"), 
	...
	TAILWHIP ("Tail Whip", MoveType.ATTRIBUTE, Type.NORMAL, false, 30, -1, 100, 0, -1, Arrays.asList("defense"), 
	...
	WITHDRAW ("Withdraw", MoveType.ATTRIBUTE, Type.WATER, true, 40, -1, -1, 0, 1, Arrays.asList("defense"), 
			"The user withdraws its body\ninto its hard shell, raising\nits Defense stat."),
	WRAP ("Wrap", MoveType.OTHER, Type.NORMAL, 20, 15, 85, 0, 4, 
			" wore off!",
			"A long body or vines are\nused to wrap and squeeze the\nfoe for two to five turns."),
	...
	private int pp, power, accuracy, level, crit, turns, priority;
	private boolean toSelf, recharge;
