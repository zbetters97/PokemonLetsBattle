...
public enum Moves {
	...
	CAPTIVATE ("Captivate", MoveType.ATTRIBUTE, Type.NORMAL, false, 20, -1, 100, 0, -2, Arrays.asList("sp. attack"), 
			"If it is the opposite gender\nof the user, the foe is\ncharmed into sharply\nlowering its Sp. Atk stat."),
	CHARM ("Charm", MoveType.ATTRIBUTE, Type.NORMAL, false, 20, -1, 100, 0, -2, Arrays.asList("attack"), 
	...
	HARDEN ("Harden", MoveType.ATTRIBUTE, Type.NORMAL, true, 30, -1, -1, 0, 1, Arrays.asList("defense"), 
	...
	IRONDEFENSE ("Iron Defense", MoveType.ATTRIBUTE, Type.STEEL, true, 15, -1, -1, 0, 2, Arrays.asList("defense"), 
	...
	METALCLAW ("Metal Claw", MoveType.PHYSICAL, Type.STEEL, true, 35, 50, 95, 0, 1, Arrays.asList("attack"),
			"The foe is raked with steel\nclaws. It may also raise the\nuser's Attack stat."),
	METEORMASH ("Meteor Mash", MoveType.PHYSICAL, Type.STEEL, true, 0.20, 10, 100, 85, 0, 1, Arrays.asList("attack"), 
	...
	PSYCHOBOOST ("Psycho Boost", MoveType.SPECIAL, Type.PSYCHIC, false, 1.0, 5, 140, 90, 0, -2, Arrays.asList("sp. attack"),
	...
	RAGE ("Rage", MoveType.PHYSICAL, Type.NORMAL, true, 20, 20, 100, 0, 1, Arrays.asList("attack"), 
	...
	SWORDSDANCE ("Swords Dance", MoveType.ATTRIBUTE, Type.NORMAL, true, 30, -1, -1, 0, 2, Arrays.asList("attack"),
